    ...
    <BookingContext.Provider value={{ open, close }}>
      ...
      {isOpen && (
        ...
        >
          ...
          />
          <div className="relative z-10 flex h-[85vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-cream shadow-2xl animate-fade-up">
            <div className="flex items-center justify-between border-b border-ink/10 px-6 py-4">
              ...
              <button
                onClick={close}
                aria-label="Close"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-ink/15 text-ink transition hover:bg-ink hover:text-cream"
              >
                <svg
                  width="16"
                  height="16"
            ...
            <iframe
              ...
              className="h-full w-full flex-1 border-0 bg-bone"
              loading="lazy"
            />
          </div>
        </div>
