...
export function Services() {
  ...
  return (
    <section id="services" className="relative scroll-mt-20 overflow-hidden bg-ink">
      ...
      <div className="container-c relative z-10 grid gap-14 px-6 py-24 md:grid-cols-2 md:gap-20 md:px-10 md:py-32">
        <div>
          <h2 className="display-lg text-bone">We handle everything.</h2>
        ...
        <div className="flex flex-col">
          {services.map((service, i) => {
            const isOpen = open === i;
            return (
              <div key={service.title} className="border-t border-bone/20 last:border-b">
                <button
                ...
                >
                  ...
                  <span
                    className={`flex h-7 w-7 shrink-0 items-center justify-center text-2xl font-light text-bone/80 transition-transform duration-300 ${
                      isOpen ? "rotate-45" : ""
                    }`}
                    aria-hidden="true"
                  >
                ...
                >
                  <div className="overflow-hidden">
                    <p className="max-w-md leading-relaxed text-bone/65">
                      {service.body}
                    </p>
                  </div>
                </div>
