...
export default function PrivacyPage() {
  return (
    <section className="bg-ink px-6 pb-24 pt-36 md:px-10 md:pt-44">
      <div className="container-c max-w-3xl">
        <p className="eyebrow mb-5">Legal</p>
        <h1 className="display-lg text-bone">Privacy Policy</h1>
        <p className="mt-4 text-sm text-bone/45">Last updated: June 2026</p>

        <div className="mt-10 space-y-6 text-bone/75 [&_a]:text-bone [&_a]:underline [&_h2]:mt-10 [&_h2]:font-display [&_h2]:text-xl [&_h2]:text-bone [&_li]:leading-relaxed [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
          <p className="text-lg">
          ...
          <p className="border-t border-bone/10 pt-6 text-sm text-bone/45">
